                        ...
                        <div class="col-md-12 col-lg-12 login-right">
                            ...
                            <div class="container d-flex justify-content-center flex-column align-items-center">
                                ...
                                <div class="text-container text-center d-flex justify-content-center align-items-center flex-column">
                                    ...
                                    <br>
                                    الذي ارسلته لنا
                                    {{ getDataFromPersonnal('phone') }} {{ getDataFromPersonnal('country_code') }}+
                                    </p>

                                    <input type="hidden" value="{{ getDataFromPersonnal('phone') }}{{ getDataFromPersonnal('country_code') }}+">
    ...
    function verify(otp) {
        coderesult.confirm(otp).then(function (result) {
            ...
            $.ajax({
                ...
                url: '{{ route("verification.check") }}',
                method: 'GET',
                data:{verification_id: coderesult.verificationId},
                success:function(){
                    window.location.href = `{{ route("register.success.information") }}`;
                },
                }).fail(function(){
                Swal.fire({
                    icon: 'error',
